...
let Enviar=document.getElementById("enviarProducto");
Enviar.addEventListener("click", (event)=>
{
    ...
    contador ++;
    document.getElementById("contadorPrductos").innerHTML=contador;
    loscalStorage.setItem("contadorProductos",contador);
    totalEnProductos += cantProducto.value;
    ...
    localStorage.setItem("elementosCatalogo", JSON.stringify(datos));
    console.log(datos);
