...
CREATE TABLE IF NOT EXISTS `g-sports`.`categorias` (
  ...
  `DescripciónCategoría` VARCHAR(300) NULL DEFAULT NULL,
  PRIMARY KEY (`idCategorias`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `g-sports`.`clientes` (
  ...
  `Alcaldía` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g-sports`.`pedidos` (
  ...
  `FechaEnvio` VARCHAR(45) NULL DEFAULT NULL,
  `FechaEntrega` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`idPedidos`, `idCliente`),
  INDEX `fk_Pedidos_1_idx` (`idCliente` ASC) VISIBLE,
  CONSTRAINT `fk_Pedidos_1`
    FOREIGN KEY (`idCliente`)
...
CREATE TABLE IF NOT EXISTS `g-sports`.`proveedores` (
  `idProveedores` CHAR(10) NOT NULL,
  `NombreCompañia` VARCHAR(45) NULL DEFAULT NULL,
  `NombreContacto` VARCHAR(45) NULL DEFAULT NULL,
  `Ciudad` VARCHAR(45) NULL DEFAULT NULL,
  `CodPostal` VARCHAR(45) NULL DEFAULT NULL,
  `Teléfono` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `g-sports`.`productos` (
  ...
  `idProveedores` CHAR(10) NOT NULL,
  `idCategorias` CHAR(10) NOT NULL,
  `NombreProducto` VARCHAR(300) NULL DEFAULT NULL,
  `PrecioUnidad` DOUBLE NULL DEFAULT NULL,
  `UnidadesExistentes` VARCHAR(45) NULL DEFAULT NULL,
  `Descripción` VARCHAR(300) NULL DEFAULT NULL,
